-- This adds a house_name column to the user details table
ALTER TABLE user_details
ADD COLUMN house_name VARCHAR(255) DEFAULT '';

-- This procedure inserts a new row into the user_details table if the user_id does not exist, 
-- otherwise it updates the existing row 
CREATE OR REPLACE PROCEDURE insert_or_update_user_details (
    _user_id UUID,
