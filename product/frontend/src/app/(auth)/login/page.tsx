...
function SignInPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-zinc-50 p-36 dark:bg-zinc-900">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="md:flex-row md:space-y-0">
          <div className="flex w-full pt-2">
            <button
              type="submit"
              className="flex flex-1 items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Login
            </button>
          </div>
